...
YOUR_CALENDAR_ID = 'a16da79d63a7f06ba9c2058e079a2f4bbb09dc41a10892438e2ecd76294153f2@group.calendar.google.com'
...
def main():
    ...
    commitHours(creds)
    addEvent(creds,2,"Hello YouTube")
        
    
    if len(argv) < 2:
        print("Usage: python timeManager.py <command>")
        return
